...
Base idea of the Moore's Voting technique is if each occurrence of an element a[i] can be cancelled with all the other elements that are different from a[i] then a[i] will exist till end if it is a majority elemen
*/
#include<bits/stdc++.h>
using namespace std;
