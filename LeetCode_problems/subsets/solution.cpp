...
/*1-total number of subsets will be-(2^n)+1 (where n is array size)
2-upper bound of a k bit number will be-(2^k)
3-the binary representation of numbers from 1 to 2^k gives permutations of set bits in k bit number.
